...
namespace KIngME_
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            int n = Convert.ToInt32(Jogo.CriarPartida(txtNomePartida.Text, txtSenhaPartida.Text, grupo));
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if(jogo_Iniciar.Substring(0,4) == "ERRO")
            {
                ...
                lblFavoritos.Text = Jogo.ListarCartas(Entrar_IdJogador, Id_Senha_Jogador[1]);
            }
